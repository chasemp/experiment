...
class MediaPanel(wx.Panel):
    ...
    def addToSongWindow(self, list_place, song):
        ...
        self.songwindow.postion = self.songwindow.InsertStringItem(0,str(list_place))

        # add values in the other columns on the same row
        self.songwindow.SetStringItem(self.songwindow.postion,1,song)

        #self.songwindow.Focus(self.songwindow.postion)

        #self.songwindow.SetItemState(self.songwindow.postion, wxLIST_STATE_SELECTED, wxLIST_STATE_SELECTED)
        #self.songwindow.SetItemState(self.songwindow.postion, wxLIST_STATE_FOCUSED, wxLIST_STATE_FOCUSED)

        #self.songwindow.SetItemState(self.songwindow.postion, wxLIST_STATE_SELECTED, wxLIST_STATE_SELECTED)
        #self.songwindow.Select(self.songwindow.postion, on=1)
