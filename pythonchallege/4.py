...
#ha tried to google some regex stuff and found this: http://stackoverflow.com/questions/7090717/regular-expression-to-match-3-capital-letters-followed-by-a-small-letter-followe

import re
matches =  re.findall(r'[a-z][A-Z]{3}([a-z])[A-Z]{3}[a-z]', string)
